...
* `docs/control-gates/sniperbot-live-money-readiness-ladder-stage-2-stock-deferral-no-action-contract-definition-review.md` -
  ...
  for externally supplied stock-lane deferral and no-action facts, explicitly
  separate from the generic asset-class evaluator and from eligibility,
  market-data, signal, strategy, risk, sizing, broker, order, and execution
  behavior. Documentation-only / governance-only / contract-definition-only /
  non-runtime / non-execution boundary; Stage 2 remains HOLD and Stage 3
  remains unentered and unauthorized.
* `docs/control-gates/sniperbot-live-money-readiness-ladder-stage-2-stock-deferral-no-action-implementation-evidence-acceptance.md` -
  SniperBot Stage 2 Stock Deferral / No-Action Implementation-Evidence
  Acceptance. Accepts only the pure evaluator, frozen structures, closed
  vocabularies, deterministic 20-step behavior, reference preservation,
  supplied-object non-mutation, and completed direct tests at `ea6b61f` and
  `153f33c`. It creates no generic-classifier integration, eligibility,
  selection, market-data, trading, execution, runtime, or Stage 3 authority.
  Documentation-only / governance-only / acceptance-record-only /
  non-runtime / non-execution boundary; Stage 2 remains HOLD and Stage 3
  remains unentered and unauthorized.
* `docs/control-gates/sniperbot-live-money-readiness-ladder-stage-2-stock-deferral-no-action-founder-decision-record.md` -
  SniperBot Stage 2 Stock Deferral / No-Action Founder Decision Record.
  Records all 16 approved founder decisions, the 22-code vocabulary, three
  stock-lane confirmation values, exact first-match precedence, optional
  contextual generic and EchoAuth boundaries, future file paths, and
  validation stops. Documentation-only / governance-only /
  founder-decision-record-only / non-runtime / non-execution boundary; Stage 2
  remains HOLD and Stage 3 remains unentered and unauthorized.
...
* `docs/control-gates/sniperbot-live-money-readiness-ladder-stage-2-options-eligibility-exclusion-founder-decision-record.md` -
  SniperBot Stage 2 Options Eligibility / Exclusion Founder-Decision Record.
  Records all 70 founder decisions, including exact request and decision
  boundaries, closed vocabularies, deterministic 12-step precedence, three
  governed undefined predicates, six-field authority evidence and
  subprecedence, exact nine-symbol future API, purity constraints, and evidence
  requirements. Schema and implementation remain unauthorized, and it grants
  no integration, trading, execution, neighboring-subject, or Stage 3
...
* `docs/control-gates/sniperbot-live-money-readiness-ladder-stage-2-stock-eligibility-exclusion-implementation-evidence-acceptance.md` -
  SniperBot Stage 2 Stock Eligibility / Exclusion Implementation-Evidence
  Acceptance. Accepts only the pure descriptive evaluator and its bounded
  direct-test evidence at implementation commit
  `f22faab66007e1100de4a3689ea34f3cfff93bbe`, dataclass-equality direct-test
  evidence completion commit `ddad1e0fe9d2bcea5929a5095cfd17296fba24b2`,
  and formal acceptance commit `5e481a9eefebc1674a3131f5b26f73b8dd277c5c`.
  This traceability entry grants no operative authority and authorizes no next
  implementation lane, integration, orchestration, market data, exchange,
  broker, wallet, networking, persistence, registration, order, routing,
  execution, runtime wiring, live-money behavior, or Stage 3 movement.
  Documentation-only / governance-only / acceptance-record-only / non-runtime
  / non-execution; Stage 2 remains HOLD and Stage 3 remains unentered and
  unauthorized.
* `docs/control-gates/sniperbot-live-money-readiness-ladder-stage-2-crypto-eligibility-exclusion-implementation-evidence-acceptance.md` -
  SniperBot Stage 2 Crypto Eligibility / Exclusion Implementation-Evidence
  Acceptance. Accepts only the pure descriptive evaluator and its bounded
  direct-test evidence at implementation commit
  `41fe2ae15ab0047af6f0c5bd4ea03f93e1996801`, direct-test evidence commit
  `9b61ca69132a29af403b780ed3a86c31e70e4f06`, and formal acceptance commit
  `4a77c9394de813d5f9a79bbc528cd2c2e435f928`. This traceability entry grants no
  operative authority and authorizes no next implementation lane, integration,
  orchestration, market data, blockchain, exchange, broker, wallet, custody,
  networking, persistence, registration, order, routing, execution, runtime
  wiring, deployment, live-money behavior, or Stage 3 movement.
  Documentation-only / governance-only / acceptance-record-only / non-runtime
  / non-execution; Stage 2 remains HOLD and Stage 3 remains unentered and
  unauthorized.
